...
public final class GpuSceneDescriptorResourcesSelfTest {
   ...
   public static void main(String[] arguments) {
      ...
      expect(IllegalArgumentException.class, () -> new GpuSceneDescriptorResources(0L, 2L, 3L, 4L, 5L, 6L, 7L, BufferRange.whole(8L, 192L), complete));
      expect(IllegalArgumentException.class, () -> new GpuSceneDescriptorResources(1L, 2L, 3L, 4L, 5L, 6L, 7L, BufferRange.whole(8L, 192L), complete.subList(0, complete.size() - 1)));
      ...
      expect(IllegalArgumentException.class, () -> new GpuSceneDescriptorResources(1L, 2L, 3L, 4L, 5L, 6L, 7L, BufferRange.whole(8L, 192L), duplicate));
   ...
   private static GpuSceneDescriptorResources resources(long tlas, long output, long colorInput, long colorOutput, long geometryInput, long geometryOutput, long motionOutput, List<GpuSceneDescriptorResources.StorageBinding> bindings) {
      return new GpuSceneDescriptorResources(tlas, output, colorInput, colorOutput, geometryInput, geometryOutput, motionOutput, BufferRange.whole(8L, 192L), bindings);
   }
