...
public final class RtMaterialUploadStatisticsSelfTest {
   ...
   private static void recordsLifecycleAndCommittedSnapshot() {
      ...
      statistics.committed(snapshot.signature(), 4, true, true, 1L, 2L, 3L, 4L, 40L, false);
   ...
   private static void rejectsInvalidEvidenceWithoutMutatingState() {
      ...
      requireFailure(() -> statistics.committed(RtSceneMaterialTable.bootstrapSnapshot().signature(), -1, true, true, 0L, 0L, 0L, 0L, 0L, false));
