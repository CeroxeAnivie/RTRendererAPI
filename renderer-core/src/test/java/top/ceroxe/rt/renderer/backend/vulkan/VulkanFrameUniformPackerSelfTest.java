...
public final class VulkanFrameUniformPackerSelfTest {
   ...
   public static void main(String[] arguments) {
      ...
      byte[] encoded = VulkanFrameUniformPacker.pack(frame, 37, sceneRevision, temporal, TemporalRenderingOptions.balanced());
      require(encoded.length == 1392, "frame ABI byte count changed");
      ...
      ByteBuffer movedWords = ByteBuffer.wrap(VulkanFrameUniformPacker.pack(movedFrame, 37, sceneRevision, movedTemporal, TemporalRenderingOptions.balanced())).order(ByteOrder.LITTLE_ENDIAN);
      require(real64(movedWords, 342) == 0.25, "high-coordinate camera delta lost sub-unit precision");
      expect(IllegalArgumentException.class, () -> VulkanFrameUniformPacker.pack(frame, -1, sceneRevision, temporal, TemporalRenderingOptions.balanced()));
      expect(IllegalArgumentException.class, () -> VulkanFrameUniformPacker.pack(frame, 0, 6L, temporal, TemporalRenderingOptions.balanced()));
