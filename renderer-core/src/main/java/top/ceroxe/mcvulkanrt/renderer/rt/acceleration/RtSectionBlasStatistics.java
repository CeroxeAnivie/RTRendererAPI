...
final class RtSectionBlasStatistics {
    ...
    void appliedBatch() { appliedBatches++; }
    void asyncBuildSubmitted() { asyncBuildSubmissions++; }
    void asyncBuildCompleted() { asyncBuildCompletions++; }
    void asyncBuildPollNotReady() { asyncBuildPollsNotReady++; }
    void asyncBuildResultDiscarded() { asyncBuildResultDiscards++; }
    void asyncBuildCloseWaited() { asyncBuildCloseWaits++; }
    void foregroundPriorityBuild() { foregroundPriorityBuilds++; }
    void backgroundReservationDeferred() { backgroundBuildReservationDeferrals++; }
    void backgroundQueueHeadDeferred() { backgroundQueueHeadDeferrals++; }
    void foregroundProgressDependencyReleased() { foregroundProgressDependencyReleases++; }
    void emptyMesh() { emptyMeshes++; }
    void fullResyncClear() { fullResyncClears++; }
