...
final class StableIdentitySlots<T> {
    ...
    static final class Prepared<T> {
        ...
        StableIdentitySlots<T> owner() { return owner; }
        long baseRevision() { return baseRevision; }
        long revision() { return revision; }
        long[] removedIds() { return removedIds.clone(); }
        List<SlotWrite<T>> writes() { return writes; }
        int[] clearedSlots() { return clearedSlots.clone(); }
        int liveCount() { return liveCount; }
        int slotUpperBound() { return slotUpperBound; }
