...
import top.ceroxe.mcvulkanrt.renderer.scene.SceneCacheBudget;
import top.ceroxe.mcvulkanrt.renderer.scene.RendererHeapBudget;
...
record RtSectionBlasConfiguration(
     ...
     * cache. A 32-chunk Minecraft view can expose far more drawable sections than the 4K CPU
