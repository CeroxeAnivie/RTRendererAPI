...
final class RtWorldTlasBuildInput {
    ...
    long sectionRevision() { return sectionRevision; }
    long sectionResourceRevision() { return sectionResourceRevision; }
    long sectionMaterialRevision() { return sectionMaterialRevision; }
    RendererViewState viewState() { return viewState; }
    long dynamicRevision() { return dynamicRevision; }
    long dynamicTopologyRevision() { return dynamicTopologyRevision; }
    long dynamicGeometryRevision() { return dynamicGeometryRevision; }
    long dynamicMaterialRevision() { return dynamicMaterialRevision; }
    DynamicRenderScene dynamicScene() { return dynamicScene; }
    int instanceTopologyHash() { return instanceTopologyHash; }
    PackedSectionMembership sectionMembership() { return sectionMembership; }
    List<SectionKey> sectionKeys() { return sectionMembership.orderedKeys(); }
    SectionRevisionSnapshot sectionContentRevisions() { return sectionContentRevisions; }
    SectionCausalitySnapshot sectionCausalities() { return sectionCausalities; }
    List<RtAccelerationStructure.TlasInstance> instances() { return instances; }
    int activeInstanceCount() { return activeInstanceCount; }
    int sectionInstanceCount() { return sectionInstanceCount; }
    int dynamicInstanceCount() { return dynamicInstanceCount; }
    int terrainMaterialCount() { return terrainMaterialCount; }
    RtSceneMaterialTable.Snapshot materialSnapshot() { return materialSnapshot; }
    long coverageContractionAuthorizationGeneration() { return coverageContractionAuthorizationGeneration; }
    int pendingSectionBuilds() { return pendingSectionBuilds; }
    long pendingTriangles() { return pendingTriangles; }
    long cachedTriangles() { return cachedTriangles; }
    boolean hasPendingSectionBuilds() { return pendingSectionBuilds > 0; }
}
