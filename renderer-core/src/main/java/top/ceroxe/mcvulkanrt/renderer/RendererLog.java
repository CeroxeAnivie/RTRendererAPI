 ...
 *
 * <p>The core must not inherit a mod loader's logger or lifecycle.  A standalone
...
public final class RendererLog {
    public static final String MINIMUM_LEVEL_PROPERTY = "mcvulkanrt.renderer.logLevel";
    private static final System.Logger SYSTEM_LOGGER = System.getLogger("top.ceroxe.mcvulkanrt.renderer");
