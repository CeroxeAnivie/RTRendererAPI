...
import top.ceroxe.mcvulkanrt.renderer.rt.pipeline.GpuSceneShaderBindings;
...
final class VulkanGpuSceneAbi {
    ...
    static final int FRAME_UNIFORM_WORDS = FRAME_LIGHTMAP_WORD
            + top.ceroxe.mcvulkanrt.renderer.api.LightmapState.ENTRY_COUNT;
