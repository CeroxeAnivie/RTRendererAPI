 ...
 * top.ceroxe.mcvulkanrt.renderer.rt.pipeline.RtFrameDispatchRequest} freezes that proof. {@link
 * top.ceroxe.mcvulkanrt.renderer.rt.pipeline.RtAsyncFrameDispatchRecorder} then owns only native
 * command recording and submission, while {@link
 * top.ceroxe.mcvulkanrt.renderer.rt.pipeline.RtPendingFrameSubmission} retains the exact proof
 * until FIFO fence completion.</p>
 *
 * <p>{@link top.ceroxe.mcvulkanrt.renderer.rt.pipeline.RtFrameSlotRing} owns output-image ring
 * replacement and delayed resource retirement. {@link
 * top.ceroxe.mcvulkanrt.renderer.rt.pipeline.RtSharedFramePublicationLedger} owns completion,
 ...
 * proof. {@link top.ceroxe.mcvulkanrt.renderer.rt.pipeline.RtFrameDispatchFlightRecorder} is the
