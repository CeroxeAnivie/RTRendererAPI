...
final class RtPendingWorldTlasBuild implements AutoCloseable {
    ...
    long revision() { return input.revision(); }
    long sectionRevision() { return input.sectionRevision(); }
    long sectionResourceRevision() { return input.sectionResourceRevision(); }
    long sectionMaterialRevision() { return input.sectionMaterialRevision(); }
    RendererViewState viewState() { return input.viewState(); }
    long dynamicRevision() { return input.dynamicRevision(); }
    long dynamicTopologyRevision() { return input.dynamicTopologyRevision(); }
    long dynamicGeometryRevision() { return input.dynamicGeometryRevision(); }
    long dynamicMaterialRevision() { return input.dynamicMaterialRevision(); }
    DynamicRenderScene dynamicScene() { return input.dynamicScene(); }
    int instanceTopologyHash() { return input.instanceTopologyHash(); }
    PackedSectionMembership sectionMembership() { return input.sectionMembership(); }
    ...
    int instanceCount() { return input.activeInstanceCount(); }
    int tlasInstanceCapacity() { return input.instances().size(); }
    int sectionInstanceCount() { return input.sectionInstanceCount(); }
    int dynamicInstanceCount() { return input.dynamicInstanceCount(); }
    int terrainMaterialCount() { return input.terrainMaterialCount(); }
    ...
    boolean submittedWithPendingBacklog() { return input.hasPendingSectionBuilds(); }
