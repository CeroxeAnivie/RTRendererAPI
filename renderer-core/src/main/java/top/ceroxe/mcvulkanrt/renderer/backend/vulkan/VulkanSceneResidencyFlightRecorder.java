...
final class VulkanSceneResidencyFlightRecorder {
    ...
    private static final long MAX_EVENTS = positiveLongProperty(
            "mcvulkanrt.takeoverFlightRecorder.sceneResidencyMaxEvents",
            65_536L
    );
    ...
    @Name("top.ceroxe.mcvulkanrt.VulkanSceneResidency")
    @Label("Vulkan RT Scene Residency")
    @Category({"MCVulkanRT", "Renderer", "GPUScene"})
    @StackTrace(false)
    ...
    @Name("top.ceroxe.mcvulkanrt.VulkanSceneResidencyCaptureLoss")
