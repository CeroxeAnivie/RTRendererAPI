...
final class RtWorldTlasDestinationPool {
    ...
    int reusableCount() { return reusable.size(); }
    long retiredBatches() { return retiredBatches; }
    long releasedRetiredBatches() { return releasedRetiredBatches; }
    long reusedDestinations() { return reusedDestinations; }
    long newDestinations() { return newDestinations; }
    long pooledDestinations() { return pooledDestinations; }
    long poolCapacityReleases() { return poolCapacityReleases; }
