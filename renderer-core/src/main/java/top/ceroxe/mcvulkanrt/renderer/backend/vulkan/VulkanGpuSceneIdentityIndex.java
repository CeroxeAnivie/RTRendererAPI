...
final class VulkanGpuSceneIdentityIndex {
    ...
    static final class Prepared {
        ...
        int textureSlot(long id) { return textures.resolve(id, reset); }
        int materialSlot(long id) { return materials.resolve(id, reset); }
        int meshSlot(long id) { return meshes.resolve(id, reset); }
        int instanceSlot(long id) { return instances.resolve(id, reset); }
        int lightSlot(long id) { return lights.resolve(id, reset); }
    }
