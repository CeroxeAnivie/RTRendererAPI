...
final class VulkanRangeArena<T> {
    ...
    static final class Prepared<T> {
        ...
        VulkanRangeArena<T> owner() { return owner; }
        long baseRevision() { return baseRevision; }
        long baseStateVersion() { return baseStateVersion; }
        long revision() { return revision; }
        Map<Long, Allocation> nextAllocations() { return nextAllocations; }
        List<PlacementWrite<T>> writes() { return writes; }
        long[] removedIds() { return removedIds.clone(); }
        Map<Long, Long> freeRanges() { return freeRanges; }
