...
public record RtGBufferSnapshot(
    ...
    @Override public float[] depth() { return depth.clone(); }
    @Override public int[] normalOct16() { return normalOct16.clone(); }
    @Override public int[] albedoRgba8() { return albedoRgba8.clone(); }
    @Override public int[] materialIds() { return materialIds.clone(); }
    @Override public int[] emissiveRgba8() { return emissiveRgba8.clone(); }
    @Override public byte[] cameraMediumIds() { return cameraMediumIds.clone(); }
