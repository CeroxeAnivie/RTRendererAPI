...
final class RtFrameCompletionPoller {
    ...
    long pollsNotReady() { return pollsNotReady; }
    long coalescedPolls() { return coalescedPolls; }
    long closeWaits() { return closeWaits; }
    long lastCompletedPolls() { return lastCompletedPolls; }
    long maxPolls() { return maxPolls; }
    long lastAgeMillis() { return lastAgeMillis; }
    long maxAgeMillis() { return maxAgeMillis; }
