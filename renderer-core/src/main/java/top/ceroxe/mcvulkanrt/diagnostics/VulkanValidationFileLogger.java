...
public final class VulkanValidationFileLogger implements AutoCloseable {
    public static final String ENABLED_PROPERTY = "mcvulkanrt.validation.enabled";
    public static final String LOG_PATH_PROPERTY = "mcvulkanrt.validation.logPath";
    ...
    private VulkanValidationFileLogger(Path logPath) throws IOException {
        ...
        this.writerThread = new Thread(this::drainMessages, "mcvulkanrt-vulkan-validation-writer");
    ...
    /** Destroys the messenger before the owning Vulkan instance is destroyed. */
    ...
    private static Path resolveLogPath() {
        ...
        Path base = Path.of(System.getProperty("user.home", "."), ".mcvulkanrt", "logs");
