...
final class RtDynamicSlotUpdateSummary {
    ...
    boolean topologyChanged() {
        return addedSlots > 0 || removedSlots > 0 || replacedSlots > 0;
    }
    ...
    int transformDirtySlots() {
        return transformDirtySlots;
    }

    int tlasInstanceDirtySlots() {
        return tlasInstanceDirtySlots;
    }

    int materialDirtySlots() {
        return materialDirtySlots;
    }
