...
import top.ceroxe.rt.renderer.DynamicModelIdentity;
 ...
 *
 * <p>The persistent GPU-scene rule used here is that dynamic scene facts are gathered
...
public final class RtDynamicBlasCache implements AutoCloseable {
     ...
     */
    /**
     * Bit marking a TLAS custom index as belonging to the dynamic material namespace.
     */
    public static final int DYNAMIC_MATERIAL_INDEX_BIT = 1 << 23;
    /**
     * Maximum local slot stored below {@link #DYNAMIC_MATERIAL_INDEX_BIT}.
     */
    ...
    /*
     * This is the CPU analogue of a persistent GPU-scene primitive index table.
    ...
    /*
     * cached RT material bindings. Transforms belong to TLAS instance
    ...
    /**
     * Creates a monitor-confined cache with no-op diagnostics.
     *
     ...
     * @param placeholderBlasDeviceAddress placeholder address
     */
    ...
    /**
     * Creates a monitor-confined owner of dynamic BLAS and asynchronous build resources.
     *
     * @param device                       logical device
     * @param allocator                    VMA allocator handle
     * @param commandContext               submission owner
    ...
    /**
     * Encodes a local dynamic material slot into Vulkan's 24-bit custom index.
     *
     * @param localMaterialSlot 23-bit local slot
    ...
    /**
     * Accepts an untraced scene generation.
     *
     * @param scene immutable source generation
    ...
    /**
     * Accepts one ordered scene generation and records its causal identity.
     *
     * @param scene     source generation
    ...
    /**
     * Advances completion and admits at most the configured asynchronous build budget.
     */
    ...
    /**
     * Freezes the current physical slot table for TLAS/material publication.
     *
    ...
    /**
     * Captures allocation-free scheduler scalars under the cache monitor.
     *
    ...
    /**
     * Returns the latest physical instance-table revision.
     *
     * @return revision
     */
    ...
    /**
     * Returns the latest resident BLAS geometry revision.
     *
     * @return revision
     */
    ...
    /**
     * Returns the latest instance-transform revision.
     *
     * @return revision
     */
    ...
    /**
     * Returns the latest packed material-table revision.
     *
     * @return revision
     */
    ...
    /**
     * Returns the latest physical-slot topology revision.
     *
     * @return revision
     */
    ...
    /**
     * Returns immutable asset residency/backlog counts.
     *
     ...
     *
     * @return immutable diagnostic states sorted by asset identity and phase
     */
     ...
     *
     * @param entityId unsigned 32-bit source object identity
     * @return joined entity lifecycle projection, or an absent projection
     */
    ...
    /**
     * Reports whether the accepted scene contains TLAS-backed geometry.
     *
    ...
    /**
     * Returns the greatest accepted source scene revision.
     *
    ...
    /**
     * Returns causal identity paired with the latest accepted scene.
     *
     * @return causality
     */
    ...
    /**
     * Releases retired BLAS generations no longer protected by TLAS revision.
     *
     * @param protectedRevision inclusive safe revision
     */
    ...
    /**
     * Formats a monitor-consistent diagnostic snapshot.
     *
     * @param name label prefix
     * @return summary
     */
