...
public final class SectionCausalitySnapshot {
    ...
    /**
     * Returns the shared empty causality publication.
     *
     * @return empty causality snapshot
     */
    ...
    /**
     * Publishes one causality identity for every revision slot.
     *
     * @param revisions immutable section revision publication
     * @param causality causality identity assigned to every revision slot
     * @return immutable causality snapshot
     */
    ...
    /**
     * Selects causality identities for an immutable revision publication.
     *
     * @param revisions immutable section revision publication
     * @param source    authoritative causality identities keyed by section
     * @return immutable causality snapshot
     */
     ...
     * @param revisions immutable section revision publication
     * @param source    authoritative causality identities keyed by section
     * @param previous  preceding snapshot eligible for page reuse
     * @return immutable causality snapshot, possibly {@code previous}
     */
    public static SectionCausalitySnapshot select(
            SectionRevisionSnapshot revisions,
            Map<SectionKey, RendererFrameCausality> source,
    ...
    /**
     * Rebinds unchanged causality pages to an equal target revision membership.
     *
     * @param targetRevisions equal-membership target revision publication
     * @return rebased immutable snapshot, or this snapshot when already bound
     */
    ...
    /**
     * Returns canonical section membership.
     *
     * @return canonical membership shared with the revision publication
     */
    ...
    /**
     * Returns the immutable revision publication aligned with causality slots.
     *
     * @return aligned section revision snapshot
     */
    ...
    /**
     * Returns the number of aligned section causality slots.
     *
     * @return causality slot count
     */
    public int size() {
    ...
    /**
     * Resolves one section's causality identity.
     *
     * @param key section identity
     * @return causality identity, or {@code null} when the section is absent
     */
