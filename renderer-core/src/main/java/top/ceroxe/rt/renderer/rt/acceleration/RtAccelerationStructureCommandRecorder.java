...
final class RtAccelerationStructureCommandRecorder {
    ...
    static void recordInputUploadBarrier(VkCommandBuffer commandBuffer, MemoryStack stack) {
        ...
        uploadBarrier.get(0)
                ...
                /* Instance, vertex and index buffers are shader reads performed by the AS build
                 * stage. AS_READ describes acceleration-structure object access, not its inputs. */
