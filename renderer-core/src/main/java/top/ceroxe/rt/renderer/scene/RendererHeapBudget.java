...
public final class RendererHeapBudget {
    ...
    /**
     * Scales a byte budget against the current maximum Java heap.
     *
     * @param baselineBytes budget used at or above the baseline heap size
     * @param minimumBytes  lower bound for small heaps
     * @return scaled byte budget
     */
    ...
    /**
     * Scales an element-count budget against the current maximum Java heap.
     *
     * @param baselineCount count used at or above the baseline heap size
     * @param minimumCount  lower bound for small heaps
     * @return scaled element count
     */
