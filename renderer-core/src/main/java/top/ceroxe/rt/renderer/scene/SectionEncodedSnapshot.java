 ...
 * @param blockStatePalette      block-state palette
 * @param fluidVoxelStatePalette fluid voxel-state palette
 * @param mediumTypePalette      medium type palette
 * @param mediumAmountPalette    medium amount palette
 * @param fluidFlowXPalette      encoded fluid x-flow palette
 * @param fluidFlowZPalette      encoded fluid z-flow palette
 * @param mapColorPalette        packed map-color palette
 * @param blockTintLayer0Palette first block tint-layer palette
 * @param blockTintLayer1Palette second block tint-layer palette
 * @param blockTintLayer2Palette third block tint-layer palette
 * @param blockTintLayer3Palette fourth block tint-layer palette
 * @param fluidMapColorPalette   packed fluid map-color palette
 * @param lightEmissionPalette   light-emission palette
 * @param materialFlagPalette    material-flag palette
 * @param shadeBrightnessPalette shade-brightness palette
 * @param runPaletteIndices      RLE palette indices
 * @param runLengths             RLE run lengths
 * @param hasOnlyAir             whether every encoded voxel is empty
 * @param hasFluid               whether any encoded voxel contains fluid
 */
public record SectionEncodedSnapshot(
    ...
    /**
     * Validates and defensively copies the encoded palette and run streams.
     */
    ...
    /**
     * Creates a legacy encoded snapshot with unavailable visual palette fields.
     *
     * @param key                 stable section identity
     * @param blockStatePalette   block-state palette
     * @param mediumAmountPalette medium-amount palette
    ...
    /**
     * Encodes a voxel snapshot into a deterministic palette and run stream.
     *
     * @param snapshot immutable source snapshot
     * @return encoded palette-and-run snapshot
     */
    ...
    /**
     * Returns the number of unique material palette entries.
     *
     * @return material palette entry count
     */
    ...
    /**
     * Returns the number of consecutive palette runs.
     *
     * @return run count
     */
    public int runCount() {
    ...
    /**
     * Decodes the voxel type at section-local coordinates.
     *
     * @param x section-local x coordinate
     * @param y section-local y coordinate
     * @param z section-local z coordinate
    ...
    /**
     * Decodes the medium state at section-local coordinates.
     *
     * @param x section-local x coordinate
     * @param y section-local y coordinate
     * @param z section-local z coordinate
    ...
    /**
     * Decodes the medium type at section-local coordinates.
     *
     * @param x section-local x coordinate
     * @param y section-local y coordinate
     * @param z section-local z coordinate
    ...
    /**
     * Decodes unsigned medium amount at section-local coordinates.
     *
     * @param x section-local x coordinate
     * @param y section-local y coordinate
     * @param z section-local z coordinate
    ...
    /**
     * Decodes signed fluid x-flow at section-local coordinates.
     *
     * @param x section-local x coordinate
     * @param y section-local y coordinate
     * @param z section-local z coordinate
     * @return signed fluid x-flow
     */
    ...
    /**
     * Decodes signed fluid z-flow at section-local coordinates.
     *
     * @param x section-local x coordinate
     * @param y section-local y coordinate
     * @param z section-local z coordinate
     * @return signed fluid z-flow
     */
    ...
    /**
     * Decodes packed map color and light at section-local coordinates.
     *
     * @param x section-local x coordinate
     * @param y section-local y coordinate
     * @param z section-local z coordinate
    ...
    /**
     * Decodes packed fluid map color at section-local coordinates.
     *
     * @param x section-local x coordinate
     * @param y section-local y coordinate
     * @param z section-local z coordinate
     * @return packed fluid map color
     */
    ...
    /**
     * Decodes one block-tint layer at section-local coordinates.
     *
     * @param x         section-local x coordinate
     * @param y         section-local y coordinate
     * @param z         section-local z coordinate
     * @param tintLayer tint layer index
     * @return packed tint-layer color, or the unavailable sentinel
     */
    ...
    /**
     * Decodes unsigned light emission at section-local coordinates.
     *
     * @param x section-local x coordinate
     * @param y section-local y coordinate
     * @param z section-local z coordinate
    ...
    /**
     * Decodes unsigned material flags at section-local coordinates.
     *
     * @param x section-local x coordinate
     * @param y section-local y coordinate
     * @param z section-local z coordinate
     * @return unsigned material flags
     */
    ...
    /**
     * Decodes unsigned shade brightness at section-local coordinates.
     *
     * @param x section-local x coordinate
     * @param y section-local y coordinate
     * @param z section-local z coordinate
    ...
    /**
     * Calculates the primitive-array payload size in bytes.
     *
     * @return primitive-array payload bytes
     */
    ...
    /**
     * Returns a defensive copy of the block-state palette.
     *
     * @return copied block-state palette
     */
    @Override
    ...
    /**
     * Returns a defensive copy of the fluid-state palette.
     *
     * @return copied fluid-state palette
     */
    @Override
    ...
    /**
     * Returns a defensive copy of the medium-type palette.
     *
     * @return copied medium-type palette
     */
    @Override
    ...
    /**
     * Returns a defensive copy of the medium-amount palette.
     *
     * @return copied medium-amount palette
     */
    @Override
    ...
    /**
     * Returns a defensive copy of the fluid x-flow palette.
     *
     * @return copied fluid x-flow palette
     */
    @Override
    ...
    /**
     * Returns a defensive copy of the fluid z-flow palette.
     *
     * @return copied fluid z-flow palette
     */
    @Override
    ...
    /**
     * Returns a defensive copy of the map-color palette.
     *
     * @return copied map-color palette
     */
    @Override
    ...
    /**
     * Returns a defensive copy of block-tint palette zero.
     *
     * @return copied first tint-layer palette
     */
    @Override
    ...
    /**
     * Returns a defensive copy of block-tint palette one.
     *
     * @return copied second tint-layer palette
     */
    @Override
    ...
    /**
     * Returns a defensive copy of block-tint palette two.
     *
     * @return copied third tint-layer palette
     */
    @Override
    ...
    /**
     * Returns a defensive copy of block-tint palette three.
     *
     * @return copied fourth tint-layer palette
     */
    @Override
    ...
    /**
     * Returns a defensive copy of the fluid map-color palette.
     *
     * @return copied fluid map-color palette
     */
    @Override
    ...
    /**
     * Returns a defensive copy of the light-emission palette.
     *
     * @return copied light-emission palette
     */
    @Override
    ...
    /**
     * Returns a defensive copy of the material-flag palette.
     *
     * @return copied material-flag palette
     */
    @Override
    ...
    /**
     * Returns a defensive copy of the shade-brightness palette.
     *
     * @return copied shade-brightness palette
     */
    @Override
    ...
    /**
     * Returns a defensive copy of the run palette-index stream.
     *
     * @return copied run palette-index stream
     */
    @Override
    ...
    /**
     * Returns a defensive copy of the run-length stream.
     *
     * @return copied run-length stream
     */
    @Override
