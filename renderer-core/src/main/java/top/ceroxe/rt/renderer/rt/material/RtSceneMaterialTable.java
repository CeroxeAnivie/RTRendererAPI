...
import top.ceroxe.rt.renderer.rt.acceleration.RtFarFieldProxyMeshBuilder;
import top.ceroxe.rt.renderer.rt.acceleration.RtSectionSourcePublication;
 ...
 *
 * <p>This component owns the immutable material generations and their GPU-visible storage.</p>
 *
...
public final class RtSceneMaterialTable implements AutoCloseable {
    ...
    /**
     * Creates a material table with no-op telemetry.
     *
    ...
    /**
     * Creates a material table with material telemetry.
     *
     * @param device            logical device
     * @param allocator         VMA allocator
     * @param materialTelemetry material telemetry sink
     */
    ...
    /**
     * Creates a material table with lifecycle telemetry.
     *
     * @param device            logical device
     * @param allocator         VMA allocator
     * @param materialTelemetry material telemetry sink
     * @param stallTelemetry    host-stall telemetry sink
     */
    public RtSceneMaterialTable(
            VkDevice device,
            long allocator,
    ...
    /**
     * Plans material-buffer upload with in-place updates enabled.
     *
     * @param previousSnapshot                previous snapshot
     * @param snapshot                        next snapshot
     * @param currentSectionBufferBytes       current section capacity
     * @param currentFaceBufferBytes          current face capacity
     * @param currentTextureRecordBufferBytes current texture-record capacity
     * @param currentTexturePixelBufferBytes  current texture-pixel capacity
     * @return deterministic upload plan
     */
    ...
    /**
     * Plans material-buffer reuse, copy, and allocation.
     *
     * @param previousSnapshot                previous snapshot
     * @param snapshot                        next snapshot
     * @param currentSectionBufferBytes       current section capacity
     ...
     * @param currentTextureRecordBufferBytes current texture-record capacity
     * @param currentTexturePixelBufferBytes  current texture-pixel capacity
     * @param allowInPlaceUpdate              whether current buffers may be updated
     * @return deterministic upload plan
     */
    public static MaterialBufferUploadPlan materialBufferUploadPlan(
            Snapshot previousSnapshot,
     ...
     *
     * @return Vulkan usage flags required by persistent material buffers
     */
    ...
    /**
     * Returns the non-empty bootstrap snapshot.
     *
    ...
    /**
     * Returns the shared single-face tombstone material.
     *
     * @return tombstone material
     */
    ...
    /**
     * Returns a tombstone spanning the requested faces.
     *
     * @param faceCount positive face count
     * @return tombstone material
     */
    ...
    /**
     * Returns bootstrap hit color in packed RGBA8.
     *
     * @return packed color
     */
    ...
    /**
     * Returns miss color in packed RGBA8.
     *
     * @return packed color
     */
    ...
    /**
     * Uploads and commits a snapshot synchronously.
     *
     * @param commandContext submission context
     * @param snapshot       immutable snapshot
     * @return whether descriptor buffers changed
     */
    ...
    /**
     * Submits an asynchronous upload allowing in-place updates.
     *
     * @param commandContext submission context
     * @param snapshot       immutable snapshot
     * @return pending upload, or {@code null} when deduplicated
     */
    ...
    /**
     * Submits an asynchronous upload.
     *
     * @param commandContext     submission context
     * @param snapshot           immutable snapshot
     * @param allowInPlaceUpdate whether current buffers may be updated
    ...
    /**
     * Activates a completed upload without waiting.
     *
     * @param pendingUpload owned pending upload
     * @return activated upload, or {@code null} while incomplete
     */
    ...
    /**
     * Returns the section-record buffer handle.
     *
     * @return native buffer handle
     */
    ...
    /**
     * Returns section-record buffer capacity.
     *
    ...
    /**
     * Returns the face-record buffer handle.
     *
     * @return native buffer handle
     */
    ...
    /**
     * Returns face-record buffer capacity.
     *
     * @return capacity in bytes
     */
    ...
    /**
     * Returns the texture-record buffer handle.
     *
     * @return native buffer handle
     */
    ...
    /**
     * Returns texture-record buffer capacity.
     *
     * @return capacity in bytes
     */
    ...
    /**
     * Returns the texture-pixel buffer handle.
     *
     * @return native buffer handle
     */
    ...
    /**
     * Returns texture-pixel buffer capacity.
     *
     * @return capacity in bytes
     */
    ...
    /**
     * Releases all retired material buffers.
     */
    ...
    /**
     * Releases buffers through a completed descriptor generation.
     *
    ...
    /**
     * Formats upload and buffer-pool diagnostics.
     *
     * @param name diagnostic prefix
    ...
    /**
     * Immutable shader material records for one stable instance slot.
     */
    public static final class SectionMaterial implements RtGpuBuffer.IntBufferWriter {
        ...
        /**
         * Creates a quad-mapped material from packed records.
         *
         * @param faceRecords packed face records
         */
        ...
        /**
         * Creates a quad-mapped material with an alpha partition.
         *
         * @param faceRecords              packed records
         * @param secondGeometryFaceOffset second geometry offset
         */
         ...
         * @param faceRecords                 packed face records
         * @param secondGeometryFaceOffset    second geometry offset
         * @param primitivesPerMaterialRecord primitives represented by each material record
         */
        ...
        /**
         * Returns the canonical packed material publication for a mesh.
         *
         ...
         *
         * @param mesh worker-owned source mesh
         * @return compact canonical publication
         */
         ...
         *
         * @param mesh source mesh
         * @return deterministic packed-record hash
         */
        ...
        /**
         * Creates packed material records for a far-field proxy.
         *
         * @param proxyMesh          proxy geometry
         * @param sourcePublications exact source publications
         * @return packed proxy material
         */
         ...
         *
         * @param mesh        source mesh
         * @param sourceFace  source face index
         * @param faceRecords destination packed records
         * @param targetFace  destination face index
         */
        ...
        /**
         * Returns packed integer stride per face.
         *
         ...
         * @return whether it produces the same packed material generation
         */
        ...
        /**
         * Returns the alpha-partition geometry offset.
         *
         * @return second geometry face offset
         */
        ...
        /**
         * Returns primitive-to-material record stride.
         *
         * @return primitives per record
         */
        ...
        /**
         * Returns packed record payload size.
         *
        ...
        /**
         * Returns deterministic packed-record hash.
         *
         * @return record hash
         */
        ...
        /**
         * Reports whether this publication still retains its source mesh.
         *
         * @return mesh-backed state
         */
         ...
         *
         * @return compact mesh-independent publication
         */
        ...
        /**
         * Returns a detached packed face-record array.
         *
         * @return packed face records
         */
    ...
    /**
     * Immutable descriptor-visible material and texture generation.
     */
    public static final class Snapshot {
        ...
        /**
         * Returns an immutable empty snapshot.
         *
        ...
        /**
         * Packs section materials at revision zero.
         *
         * @param sectionMaterials slot-ordered materials
        ...
        /**
         * Packs section materials with an implicit layout hash.
         *
         * @param sectionMaterials slot-ordered materials
         * @param revision         material revision
         * @return immutable snapshot
         */
        ...
        /**
         * Packs section materials with explicit generation identity.
         *
         * @param sectionMaterials   slot-ordered materials
         * @param revision           material revision
         * @param instanceLayoutHash layout hash
         * @return immutable snapshot
         */
        ...
        /**
         * Derives changed material slots against a previous generation.
         *
         * @param previousSnapshot   previous generation
         * @param sectionMaterials   next materials
         * @param revision           next revision
         * @param instanceLayoutHash next layout hash
        ...
        public static Snapshot fromSectionMaterialsIncremental(
            ...
            int faceCapacity = 0;
            /*
             * Stable RT material frames are the common case. Persistent GPU-scene
        ...
        /**
         * Builds an incremental snapshot from exact dirty-slot hints.
         *
         * @param previousSnapshot   previous generation
         * @param sectionMaterials   next materials
         * @param dirtySlotHints     exact dirty slots
         * @param revision           next revision
         * @param instanceLayoutHash next layout hash
         * @return incremental snapshot
         */
        ...
        /**
         * Packs stable sparse material slots.
         *
         * @param sectionMaterials   slot materials
         * @param sectionFirstFaces  per-slot offsets
         * @param faceCapacity       total face capacity
         * @param revision           material revision
         * @param instanceLayoutHash layout hash
         * @return immutable snapshot
         */
        ...
        /**
         * Composes changed base and appended generations incrementally.
         *
         * @param previousComposite  previous result
         * @param previousBase       previous base
         * @param nextBase           next base
         * @param previousAppended   previous suffix
         * @param nextAppended       next suffix
        ...
        /**
         * Appends material facts to a base snapshot.
         *
         * @param base               base snapshot
         * @param appendedMaterials  appended facts
         * @param revision           result revision
         * @param instanceLayoutHash layout hash
         * @return composed snapshot
         */
        ...
        /**
         * Composes two snapshots.
         *
         * @param base               base snapshot
         * @param appended           appended snapshot
         * @param revision           result revision
         * @param instanceLayoutHash layout hash
         * @return composed snapshot
         */
         ...
         *
         * @param prefixSections     number of leading sections to retain
         * @param revision           result revision
         * @param instanceLayoutHash result layout hash
         * @return immutable prefix snapshot
         */
         ...
         *
         * @param prefixSections     number of leading sections to exclude
         * @param revision           result revision
         * @param instanceLayoutHash result layout hash
         * @return immutable suffix snapshot
         */
        ...
        /**
         * Returns the bound texture generation.
         *
        ...
        /**
         * Rebinds this material generation to a texture snapshot.
         *
         * @param replacementTextureSnapshot replacement textures
        ...
        /**
         * Rebinds this generation to the current catalog.
         *
         * @return rebound snapshot
         */
        ...
        /**
         * Returns fallback-color face count.
         *
         * @return face count
         */
        ...
        /**
         * Returns immutable snapshot identity.
         *
         * @return signature
         */
        ...
        /**
         * Returns instance-to-slot layout hash.
         *
         * @return layout hash
         */
        ...
        /**
         * Computes upload ranges from a previous snapshot.
         *
         * @param previousSnapshot previous generation
         * @param forceFullUpload  whether to force all ranges
         * @return upload diff
         */
        ...
        /**
         * Returns immutable slot-ordered material facts.
         *
        ...
        /**
         * Returns a detached section-record array.
         *
        ...
        /**
         * Returns a detached face-record array.
         *
         * @return face records
         */
        public int[] faceRecords() {
        ...
        /**
         * Returns detached per-section face offsets.
         *
         * @return first-face offsets
         */
    ...
    /**
     * Immutable equality signature for one material snapshot generation.
     *
     * @param sectionCount           section count
     * @param faceCount              face count
     * @param fallbackColorFaceCount fallback-color face count
     * @param fluidFaceCount         fluid face count
     * @param emissiveFaceCount      emissive face count
    ...
    public record SnapshotSignature(
        ...
        /**
         * Validates non-negative bounded signature counts.
         */
    ...
    /**
     * Immutable dirty-range accounting for one upload.
     *
     * @param dirtySectionRecords     dirty section records
     * @param dirtyFaceRecords        dirty face records
     * @param dirtyTextureRecords     dirty texture records
     * @param dirtyTexturePixels      dirty texture pixels
     * @param dirtySectionBytes       dirty section bytes
     * @param dirtyFaceBytes          dirty face bytes
     * @param dirtyTextureRecordBytes dirty texture-record bytes
     * @param dirtyTexturePixelBytes  dirty texture-pixel bytes
     * @param stagedBytes             total staged bytes
     * @param fullUpload              whether the complete generation is uploaded
     */
    public record MaterialUploadDiff(
        ...
        /**
         * Validates non-negative upload counts and byte sizes.
         */
    ...
    /**
     * Immutable buffer reuse/allocation plan for one upload.
     *
     * @param inPlace                    whether existing buffers are updated
     * @param materialBuffersChanged     whether descriptor-visible buffers change
     * @param fullUpload                 whether all records are uploaded
     * @param copiedPreviousBytes        bytes copied from the previous generation
    ...
    public record MaterialBufferUploadPlan(
        ...
        /**
         * Validates buffer-plan byte counts and mutually exclusive modes.
         */
    ...
    /**
     * Owns one submitted upload until activation or closure.
     */
    public final class PendingUpload implements AutoCloseable {
        ...
        /**
         * Reports whether submission allocated replacement descriptor buffers.
         *
         * @return buffer-change state
         */
    ...
    /**
     * Transactional owner of an activated upload awaiting commit or rollback.
     */
    public final class ActivatedUpload {
        ...
        /**
         * Reports whether activation changed descriptor-visible buffers.
         *
         * @return buffer-change state
         */
        public boolean materialBuffersChanged() {
        ...
        /**
         * Commits without retaining an older descriptor generation.
         */
        ...
        /**
         * Commits and retires previous buffers behind a descriptor generation.
         *
         * @param retiredDescriptorGeneration generation that may still reference previous buffers
         */
        ...
        /**
         * Restores the pre-activation material generation and buffer ownership.
         */
