...
public final class PackedSectionMembership extends AbstractSet<SectionKey> {
    ...
    /**
     * Returns the shared empty membership publication.
     *
     * @return the immutable empty membership
     */
     ...
     *
     * @param source section keys to publish
     * @return an immutable membership containing the supplied keys in iteration order
     * @throws NullPointerException     if {@code source} or any key is {@code null}
     * @throws IllegalArgumentException if {@code source} contains a duplicate key
     */
     ...
     *
     * @param source          section keys to publish
     * @param reusableColumns preceding publication whose unchanged column payloads may be reused
     * @return an immutable membership containing the supplied keys in iteration order
     * @throws NullPointerException     if {@code source} or any key is {@code null}
     * @throws IllegalArgumentException if {@code source} contains a duplicate key
     */
     ...
     *
     * @param source section keys whose first occurrences are retained
     * @return an immutable, canonically ordered membership
     * @throws NullPointerException if {@code source} or any key is {@code null}
     */
    ...
    /**
     * Freezes first-occurrence membership in canonical spatial order and reuses unchanged column
     * payloads from a preceding publication when possible.
     *
     * @param source          section keys whose first occurrences are retained
     * @param reusableColumns preceding publication whose unchanged storage may be reused
     * @return an immutable, canonically ordered membership
     * @throws NullPointerException if {@code source} or any key is {@code null}
     */
    ...
    /**
     * Starts a primitive section-node publication with no intermediate {@link SectionKey}
     * collection.
     *
     * @param expectedSections expected number of distinct sections
     * @return a mutable builder sized for the expected membership
     * @throws IllegalArgumentException if {@code expectedSections} is negative
     */
     ...
     *
     * @param keys candidate canonical key storage
     * @param key  section key to locate
     * @return the canonical index, or {@link Integer#MIN_VALUE} when specialized storage is absent
     * @throws NullPointerException if {@code keys} or {@code key} is {@code null}
     */
     ...
     *
     * @param retainedSections keys permitted to remain in the publication
     * @return this publication when unchanged, or an immutable filtered publication
     * @throws NullPointerException if {@code retainedSections} is {@code null}
     */
    ...
    /**
     * Returns the immutable key view in publication iteration order.
     *
     * @return the ordered section keys
     */
     ...
     *
     * @param key section key to locate
     * @return the canonical zero-based index, or a negative value when the key is absent
     * @throws NullPointerException  if {@code key} is {@code null}
     * @throws IllegalStateException if this publication is not canonically ordered
     */
    ...
    /**
     * Reports whether iteration follows canonical spatial order.
     *
     * @return {@code true} when this membership is canonically ordered
     */
    ...
    /**
     * Returns an immutable primitive-backed view of represented chunk columns.
     *
     * @return the chunk columns containing at least one published section
     */
    ...
    /**
     * Returns the immutable map used by extraction workers to select each column's vertical
     * section ticket.
     *
     * @return immutable section memberships grouped by chunk column
     */
    ...
    /**
     * Returns the immutable set of sections published in a chunk column.
     *
     * @param chunkKey chunk column to query
     * @return the column's sections, or an empty set when the column is absent
     * @throws NullPointerException if {@code chunkKey} is {@code null}
     */
    ...
    /**
     * Performs a fixed-cost primitive column lookup for probes that do not own a {@link ChunkKey}.
     *
     * @param chunkX chunk-column X coordinate
     * @param chunkZ chunk-column Z coordinate
     * @return the column's immutable section set, or an empty set when absent
     */
    ...
    /**
     * Tests whether this publication contains any section in a chunk column.
     *
     * @param chunkKey chunk column to test
     * @return {@code true} when the column contains at least one published section
     * @throws NullPointerException if {@code chunkKey} is {@code null}
     */
    ...
    /**
     * Provides the fixed-cost primitive counterpart to {@link #containsChunk(ChunkKey)}.
     *
     * @param chunkX chunk-column X coordinate
     * @param chunkZ chunk-column Z coordinate
     * @return {@code true} when the column contains at least one published section
    ...
    /**
     * Returns an iterator over section keys in publication order.
     *
     * @return an iterator over the immutable membership
     */
    @Override
    ...
    /**
     * Returns the number of published sections.
     *
     * @return the membership size
     */
    @Override
    public int size() {
    ...
    /**
     * Tests whether an object identifies a published section.
     *
     * @param candidate object to test
     * @return {@code true} when {@code candidate} is a contained {@link SectionKey}
     */
    @Override
    ...
    /**
     * Tests whether every candidate belongs to this membership.
     *
     * @param candidates objects to test
     * @return {@code true} when every candidate is contained
    ...
    /**
     * Tests a packed section coordinate without materializing a {@link SectionKey}.
     *
     * @param packedSection packed section coordinate
     * @return {@code true} when the coordinate is present
     */
     ...
     *
     * @param sectionKey section to add
     * @return this publication when already present, or a canonical successor containing the key
     * @throws NullPointerException if {@code sectionKey} is {@code null}
     */
    ...
    /**
     * Publishes one canonical membership removal with the same copy-on-write ownership contract.
     *
     * @param sectionKey section to remove
     * @return this publication when absent, or a canonical successor without the key
     * @throws NullPointerException if {@code sectionKey} is {@code null}
     */
     ...
     *
     * @param enteredSections distinct absent sections entering the publication
     * @param retiredSections distinct present sections retiring from the publication
     * @return this publication for an empty delta, or its canonical successor
     * @throws NullPointerException     if either collection or any contained key is {@code null}
     * @throws IllegalArgumentException if a delta key violates the documented lifecycle state
     */
     ...
     *
     * @param superset         candidate current superset publication
     * @param previousSubset   previously validated subset publication
     * @param previousSuperset previously validated superset publication
     * @return {@code true} when the prior subset proof remains valid across both transitions
     * @throws NullPointerException if any publication argument is {@code null}
     */
     ...
     *
     * @param other                     current publication whose intersection is counted
     * @param previousThis              preceding publication for this membership
     * @param previousOther             preceding publication for {@code other}
     * @param previousIntersectionCount previously validated intersection size
     * @return the updated intersection size, or {@code -1} when either transition is unrelated
     * @throws NullPointerException     if any publication argument is {@code null}
     * @throws IllegalArgumentException if {@code previousIntersectionCount} is outside prior bounds
     * @throws IllegalStateException    if valid-looking deltas produce an impossible intersection size
     */
    ...
    public static final class Builder {
        ...
        /**
         * Clears accumulated membership and prepares this builder for another publication.
         *
         * @param expectedSections expected number of distinct sections in the next publication
         * @return this builder
         * @throws IllegalArgumentException if {@code expectedSections} is negative
         */
        ...
        /**
         * Adds a packed section coordinate when it has not already been accumulated.
         *
         * @param packedSection packed section coordinate to add
         * @return {@code true} when the coordinate was added; {@code false} for a duplicate
         * @throws IllegalStateException if this builder has already published a membership
         */
        ...
        /**
         * Adds a section key when it has not already been accumulated.
         *
         * @param sectionKey section key to add
         * @return {@code true} when the key was added; {@code false} for a duplicate
         * @throws NullPointerException  if {@code sectionKey} is {@code null}
         * @throws IllegalStateException if this builder has already published a membership
         */
        ...
        /**
         * Returns the number of distinct accumulated section coordinates.
         *
         * @return the current builder size
         */
        public int size() {
            return size;
        }
        ...
        /**
         * Publishes the accumulated coordinates in canonical order, structurally sharing unchanged
         * storage with a preceding canonical publication when possible.
         *
         * @param previous preceding publication eligible for structural sharing, or {@code null}
         * @return an immutable canonical membership
         * @throws IllegalStateException if this builder has already published a membership
         */
