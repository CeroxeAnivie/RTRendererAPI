 ...
 * host-independent geometry contract that lets entity/drop-like facts participate in the
...
public final class RtDynamicTriangleMesh {
    ...
    /**
     * Builds the legacy scene-batch geometry owned by the renderer.
     *
     * @param scene immutable dynamic scene generation
     * @return a mesh, or {@code null} when no primitive uses generated TLAS geometry
     */
    ...
    /**
     * Returns a defensive copy of tightly packed XYZ positions.
     *
    ...
    /**
     * Returns a defensive copy of unsigned triangle indices.
     *
    ...
    /**
     * Returns the number of source primitives represented by this mesh.
     *
     * @return source primitive count
     */
    ...
    /**
     * Returns packed material-record count.
     *
     * @return material face count
     */
    ...
    /**
     * Returns triangle coverage per packed material record.
     *
    ...
    /**
     * Returns the indexed triangle count.
     *
