...
final class RtSceneWorkFlightRecorder {
    ...
    @Name("top.ceroxe.rt.SectionBlasApplyPhase")
    @Label("RTRenderer Section BLAS Apply Phase")
    ...
    @Name("top.ceroxe.rt.WorldTlasSchedulerPhase")
    @Label("RTRenderer World TLAS Scheduler Phase")
    @Category({"RTRenderer", "Acceleration", "TLAS"})
    @StackTrace(false)
