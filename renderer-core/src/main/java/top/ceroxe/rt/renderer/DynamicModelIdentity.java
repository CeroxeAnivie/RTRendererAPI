...
/**
 * Stable identity encoding shared by the host capture boundary and RT
...
public final class DynamicModelIdentity {
     ...
     * 编码一个归属于动态实体模型的图元标识。
     *
     * @param entityId     无符号 32 位实体标识
     * @param modelOrdinal 实体内 0..255 模型序号
     * @param cubeOrdinal  模型内 0..65535 几何序号
     * @return 带实体模型命名空间的稳定图元标识
     */
     ...
     * 提取实体模型图元编码的所有者标识。
     *
     * @param primitiveId 待解析的图元标识
     * @return 编码的无符号实体标识；不属于该命名空间时返回 {@code -1}
     */
