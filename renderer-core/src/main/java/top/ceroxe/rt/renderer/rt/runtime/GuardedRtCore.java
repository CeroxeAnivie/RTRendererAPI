...
import top.ceroxe.rt.renderer.rt.device.RtResourceScope;
import top.ceroxe.rt.renderer.rt.device.VulkanRtDeviceContext;
...
public final class GuardedRtCore implements RtCore {
    ...
    /**
     * Creates a guarded core backed by a no-op native backend.
     */
    ...
    /**
     * Creates a guarded core with an injected native-backend factory.
     *
     * @param nativeBackendFactory factory invoked after capability acceptance
     */
    ...
    /**
     * Creates a production core with disabled diagnostics callbacks.
     *
     * @return production runtime core
     */
    ...
    /**
     * Creates a production core using the supplied diagnostics callbacks.
     *
     * @param diagnostics diagnostics sink retained by the native backend
     * @return production runtime core
     */
     ...
     *
     * @return independently initialized hardware-test core
     */
    ...
    public void acceptCapability(VulkanRtCapabilityProbe.Result capability) {
        ...
        try {
            ...
            if (state.compareAndSet(State.INITIALIZING_BACKEND, State.DISABLED_BACKEND_FAILURE)) {
                top.ceroxe.rt.renderer.RendererLog.error(
    ...
    /**
     * Opens native backends after capability validation.
     */
    @FunctionalInterface
    public interface NativeBackendFactory {
        /**
         * Opens a backend whose resources belong to the supplied scope.
         *
         * @param capability validated capability result
         * @param scope      resource scope that owns all created native handles
    ...
    /**
     * Native backend contract protected by the guarded runtime lifecycle.
     */
    public interface NativeBackend {
        /**
         * Accepts a new view state.
         *
        ...
        /**
         * Accepts a view state and presentation sections that must remain retained.
         *
         * @param viewState                    immutable view state
         * @param retainedPresentationSections immutable presentation retention set
         */
        ...
        /**
         * Accepts typed foreground authority work.
         *
         * @param work immutable foreground handoff
         */
        ...
        /**
         * Accepts the immutable changes for one frame.
         *
        ...
        /**
         * Accepts a frame submission envelope while preserving its update payload.
         *
         * @param submission immutable frame submission
         */
        ...
        /**
         * Returns the latest frame snapshot.
         *
         * @return latest snapshot, or {@code null} when unsupported
         */
        ...
        /**
         * Returns the latest G-buffer capture.
         *
         * @return latest snapshot, or {@code null} when unavailable
         */
        ...
        /**
         * Returns the latest shared-frame sequence.
         *
         * @return sequence, or a negative value when unavailable
         */
        ...
        /**
         * Returns the latest shared-frame terrain coverage.
         *
        ...
        /**
         * Returns an atomic shared-frame state projection.
         *
        ...
        /**
         * Exports the latest shared frame.
         *
         * @return owned shared image, or {@code null} when unavailable
         */
        ...
        /**
         * Exports a shared frame with an exact state sequence.
         *
         * @param requiredFrameStateSequence exact sequence required
         * @return owned matching image, or {@code null} when unavailable
         */
        ...
        /**
         * Acknowledges presentation of an exported frame.
         *
         * @param frameStateSequence presented frame sequence
         * @param vulkanImage        nonzero native image handle
         * @return {@code true} when a pending frame was acknowledged
         */
        ...
        /**
         * Returns backend activity counters.
         *
        ...
        /**
         * Returns the latest native frame timing.
         *
        ...
        /**
         * Returns the latest native dispatch decision.
         *
         * @return immutable dispatch decision
         */
        ...
        /**
         * Returns aggregate dynamic-scene generation state.
         *
        ...
        /**
         * Returns generation state for one terrain section.
         *
        ...
        /**
         * Returns generation state for one dynamic entity.
         *
        ...
        /**
         * Returns the atomic descriptor-visible scene publication.
         *
        ...
        /**
         * Returns native terrain lifecycle ownership.
         *
        ...
        /**
         * Returns the scalar native terrain ownership generation.
         *
         * @return generation, or a negative value when unavailable
         */
        ...
        /**
         * Returns the current scene readiness decision.
         *
        ...
        /**
         * Probes external-memory interoperability.
         *
        ...
        /**
         * Probes external-semaphore interoperability.
         *
         * @return immutable probe result
         */
        ...
        /**
         * Returns a compact human-readable backend summary.
         *
