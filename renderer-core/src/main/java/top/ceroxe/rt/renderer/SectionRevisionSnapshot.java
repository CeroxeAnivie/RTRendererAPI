...
public final class SectionRevisionSnapshot extends AbstractMap<SectionKey, Long> {
     ...
     *
     * @param sectionKeys section identities to publish
     * @param revision    revision assigned to every identity
     * @return canonical immutable snapshot
     */
     ...
     *
     * @param canonicalSectionKeys canonical coverage order
     * @param sourceRevisions      authoritative source revisions
     * @return selected immutable snapshot
     */
     ...
     *
     * @param membership      canonical membership owner
     * @param sourceRevisions authoritative revisions
     * @return selected immutable snapshot
     */
    public static SectionRevisionSnapshot select(
     ...
     * @return selected immutable snapshot, possibly {@code previous}
     */
    public static SectionRevisionSnapshot select(
            PackedSectionMembership membership,
            Map<SectionKey, Long> sourceRevisions,
     ...
     *
     * @param sectionKeys     selected keys
     * @param sourceRevisions authoritative revisions
     * @param missingRevision value for absent keys
     * @return selected immutable snapshot
     */
    public static SectionRevisionSnapshot select(
            Collection<SectionKey> sectionKeys,
     ...
     *
     * @param revisions source revision map
     ...
     *
     * @param revisions       source map
     * @param key             section identity
     * @param defaultRevision absent value
     * @return stored or default revision
     */
    ...
    /**
     * Returns the canonical membership retained by this snapshot.
     *
     * @return canonical membership object retained by this snapshot
     */
