...
public final class SectionBoundarySnapshot {
    ...
    /**
     * Creates an immutable defensive copy of all geometry- and light-shell samples.
     *
     * @param voxelTypeIds          geometry-shell voxel type identifiers
     * @param mediumStateIds        geometry-shell medium state identifiers
     * @param mediumTypeIds         geometry-shell medium type identifiers
     * @param mediumAmounts         geometry-shell medium amounts
     * @param geometryMaterialFlags geometry-shell material flags
     * @param packedMapColors       light-shell packed map colors
     * @param lightEmissions        light-shell emission values
     * @param lightMaterialFlags    light-shell material flags
     * @param shadeBrightnesses     light-shell shade brightness values
     */
     ...
     *
     * @return fresh one-shot boundary builder
     */
    ...
    /**
     * Returns the number of first-shell geometry samples.
     *
     * @return geometry-shell sample count
     */
    ...
    /**
     * Returns the number of first- and second-shell lighting samples.
     *
     * @return light-shell sample count
     */
    ...
    /**
     * Tests whether a coordinate belongs to the captured geometry shell.
     *
     * @param x section-local x coordinate
     * @param y section-local y coordinate
     * @param z section-local z coordinate
     * @return {@code true} when the coordinate is in the geometry shell
     */
    ...
    /**
     * Tests whether a coordinate belongs to the captured lighting shell.
     *
     * @param x section-local x coordinate
     * @param y section-local y coordinate
     * @param z section-local z coordinate
     * @return {@code true} when the coordinate is in the light shell
     */
    ...
    /**
     * Resolves a captured geometry-shell coordinate to its packed index.
     *
     * @param x section-local x coordinate
     * @param y section-local y coordinate
     * @param z section-local z coordinate
     * @return packed geometry-shell index
     */
    ...
    /**
     * Resolves a captured light-shell coordinate to its packed index.
     *
     * @param x section-local x coordinate
     * @param y section-local y coordinate
     * @param z section-local z coordinate
     * @return packed light-shell index
     */
    ...
    /**
     * Reads an unsigned boundary medium amount.
     *
     * @param x section-local x coordinate
     * @param y section-local y coordinate
     * @param z section-local z coordinate
    ...
    /**
     * Reads unsigned geometry material flags.
     *
     * @param x section-local x coordinate
     * @param y section-local y coordinate
     * @param z section-local z coordinate
    ...
    /**
     * Reads packed boundary map color and light.
     *
     * @param x section-local x coordinate
     * @param y section-local y coordinate
     * @param z section-local z coordinate
    ...
    /**
     * Reads unsigned boundary light emission.
     *
     * @param x section-local x coordinate
     * @param y section-local y coordinate
     * @param z section-local z coordinate
    ...
    /**
     * Reads unsigned light-shell material flags.
     *
     * @param x section-local x coordinate
     * @param y section-local y coordinate
     * @param z section-local z coordinate
    ...
    /**
     * Reads unsigned boundary shade brightness.
     *
     * @param x section-local x coordinate
     * @param y section-local y coordinate
     * @param z section-local z coordinate
    ...
    /**
     * Tests logical equality of every captured boundary page.
     *
     * @param other candidate snapshot
     * @return {@code true} when all captured boundary pages are equal
     */
    ...
    /**
     * Estimates retained primitive page bytes.
     *
    ...
    /**
     * Mutable one-shot staging builder for a packed boundary snapshot.
     */
    public static final class Builder {
        ...
        /**
         * Sets one geometry-shell voxel state.
         *
         * @param index packed geometry-shell index
         * @param value voxel state identifier
         */
        ...
        /**
         * Sets one geometry-shell fluid state.
         *
         * @param index packed geometry-shell index
         * @param value medium state identifier
         */
        ...
        /**
         * Sets one geometry-shell fluid type.
         *
         * @param index packed geometry-shell index
         * @param value medium type identifier
         */
        ...
        /**
         * Sets one geometry-shell fluid amount.
         *
         * @param index packed geometry-shell index
         * @param value encoded medium amount
         */
        ...
        /**
         * Sets one geometry-shell material classification.
         *
         * @param index packed geometry-shell index
         * @param value encoded material flags
         */
        ...
        /**
         * Sets one light-shell packed map color.
         *
         * @param index packed light-shell index
         * @param value packed map color
         */
        ...
        /**
         * Sets one light-shell emission value.
         *
         * @param index packed light-shell index
         * @param value encoded emission value
         */
        ...
        /**
         * Sets one light-shell material classification.
         *
         * @param index packed light-shell index
         * @param value encoded material flags
         */
        ...
        /**
         * Sets one light-shell shade brightness.
         *
         * @param index packed light-shell index
         * @param value encoded shade brightness
         */
        ...
        /**
         * Publishes the accumulated pages exactly once.
         *
         * @return immutable boundary snapshot
         */
