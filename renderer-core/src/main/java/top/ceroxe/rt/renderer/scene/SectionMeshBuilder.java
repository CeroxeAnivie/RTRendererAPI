...
/**
 * Converts immutable section faces into packed fixed-point triangle meshes.
 */
public final class SectionMeshBuilder {
    ...
    /**
     * Creates a builder with production texture/model resolvers.
     */
    ...
    /**
     * Builds one immutable triangle mesh from a geometry snapshot.
     *
     * @param geometry immutable section geometry
     * @return packed immutable triangle mesh
     */
