...
public final class RtDynamicTlasCache implements AutoCloseable {
     ...
     * can observe a new acceleration structure. Persistent primitive data remains
    ...
    /**
     * Creates a monitor-confined owner for all dynamic TLAS generations.
     *
    ...
    /**
     * Advances the default-cadence TLAS state machine.
     *
     * @param input frozen physical slots
     * @return bind candidate or {@code null}
     */
    ...
    /**
     * Advances with explicit capture causality.
     *
     * @param input     frozen slots
     ...
     *
     * @param input current lightweight producer revisions
     * @return completed candidate awaiting descriptor ownership, or {@code null}
     */
     ...
     *
     * @param input producer revisions
     ...
     *
     * @param input                            producer revisions
     * @param transformOnlyUpdateIntervalNanos coalescing interval in nanoseconds
     * @return snapshot requirement
     */
    ...
    /**
     * Advances completed work while coalescing only transform-only successors.
     *
     * @param input                            frozen physical slots
     * @param transformOnlyUpdateIntervalNanos coalescing interval in nanoseconds
     * @return bind candidate or {@code null}
    ...
    /**
     * Advances the state machine with explicit cadence and capture identity.
     *
     * @param input                            frozen slots
     * @param transformOnlyUpdateIntervalNanos interval in nanoseconds
     * @param causality                        capture identity
     * @return bind candidate or {@code null}
     */
    public synchronized Update process(
    ...
    /**
     * Transfers the exact candidate into descriptor-visible ownership.
     *
     * @param update                      owned candidate
     * @param retiredDescriptorGeneration generation protecting its predecessor
     */
    ...
    /**
     * Proves candidate identity and predecessor ownership before descriptor mutation.
     *
     * @param update                      candidate
     * @param retiredDescriptorGeneration non-negative generation
     */
     ...
     *
     * @param update exact unbound candidate to recycle
     */
    ...
    /**
     * Releases TLAS allocations whose descriptor generations completed.
     *
    ...
    /**
     * Returns monitor-consistent ownership and scheduler diagnostics.
     *
    ...
    /**
     * Completed dynamic TLAS generation awaiting an atomic descriptor bind.
     *
     * @param topLevelAccelerationStructure candidate TLAS owner
     * @param previous                      predecessor owner
     * @param revision                      input revision
     * @param topologyRevision              topology revision
     * @param geometryRevision              geometry revision
     * @param transformRevision             transform revision
     * @param instanceLayoutHash            physical layout token
     * @param dynamicScene                  source scene
     * @param activeInstances               active instance count
     * @param capacity                      physical capacity
     * @param instanceSnapshot              candidate-owned source snapshot
     * @param causality                     capture identity
     */
    public record Update(
        ...
        /**
         * Validates unique native ownership and immutable snapshot/revision consistency.
         */
        public Update {
