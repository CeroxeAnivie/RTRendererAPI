...
final class VulkanGpuSceneAbi {
    ...
    /** Exact projection tail; the legacy 0..351 prefix remains byte-for-byte stable. */
    static final int FRAME_PROJECTION_PATH_WORD = 352;
    static final int FRAME_EXACT_VIEWPORT_WIDTH_WORD = 353;
    static final int FRAME_EXACT_VIEWPORT_HEIGHT_WORD = 354;
    static final int FRAME_EXACT_DEPTH_CONVENTION_WORD = 355;
    static final int FRAME_EXACT_JITTER_CONVENTION_WORD = 356;
    static final int FRAME_EXACT_JITTER_WORD = 357;
    static final int FRAME_EXACT_COORDINATE_SYSTEM_WORD = 359;
    static final int FRAME_EXACT_INVERSE_CLIP_FROM_VIEW_WORD = 360;
    static final int FRAME_EXACT_CAMERA_TO_WORLD_WORD = 376;
    static final int FRAME_UNIFORM_WORDS = 400;

    static final int PROJECTION_PATH_BASIS_FOV = 0;
    static final int PROJECTION_PATH_EXACT_CLIP = 1;
    ...
    static Map<String, Integer> shaderDefines() {
        ...
        values.put("GPU_SCENE_FRAME_PROJECTION_PATH_WORD", FRAME_PROJECTION_PATH_WORD);
        values.put("GPU_SCENE_FRAME_EXACT_VIEWPORT_WIDTH_WORD", FRAME_EXACT_VIEWPORT_WIDTH_WORD);
        values.put("GPU_SCENE_FRAME_EXACT_VIEWPORT_HEIGHT_WORD", FRAME_EXACT_VIEWPORT_HEIGHT_WORD);
        values.put("GPU_SCENE_FRAME_EXACT_DEPTH_CONVENTION_WORD", FRAME_EXACT_DEPTH_CONVENTION_WORD);
        values.put("GPU_SCENE_FRAME_EXACT_JITTER_CONVENTION_WORD", FRAME_EXACT_JITTER_CONVENTION_WORD);
        values.put("GPU_SCENE_FRAME_EXACT_JITTER_WORD", FRAME_EXACT_JITTER_WORD);
        values.put("GPU_SCENE_FRAME_EXACT_COORDINATE_SYSTEM_WORD", FRAME_EXACT_COORDINATE_SYSTEM_WORD);
        values.put("GPU_SCENE_FRAME_EXACT_INVERSE_CLIP_FROM_VIEW_WORD", FRAME_EXACT_INVERSE_CLIP_FROM_VIEW_WORD);
        values.put("GPU_SCENE_FRAME_EXACT_CAMERA_TO_WORLD_WORD", FRAME_EXACT_CAMERA_TO_WORLD_WORD);
        values.put("GPU_SCENE_PROJECTION_PATH_BASIS_FOV", PROJECTION_PATH_BASIS_FOV);
        values.put("GPU_SCENE_PROJECTION_PATH_EXACT_CLIP", PROJECTION_PATH_EXACT_CLIP);
