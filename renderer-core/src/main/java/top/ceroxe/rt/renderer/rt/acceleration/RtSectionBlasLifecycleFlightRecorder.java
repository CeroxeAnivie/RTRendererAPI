...
final class RtSectionBlasLifecycleFlightRecorder {
    static final String EVENT_NAME = "top.ceroxe.rt.SectionBlasLifecycle";
    static final String CAPTURE_LOSS_EVENT_NAME = "top.ceroxe.rt.SectionBlasCaptureLoss";
    ...
    private static final long DEFAULT_MAX_EVENTS = positiveLongProperty(
            "top.ceroxe.rt.takeoverFlightRecorder.sectionBlasMaxEvents", 65_536L
    );
