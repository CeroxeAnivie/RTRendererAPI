...
public record SectionKey(int x, int y, int z) {
    ...
    /**
     * Packs validated section coordinates into the stable 64-bit layout.
     *
     * @param x section x coordinate
     * @param y section y coordinate
     * @param z section z coordinate
     * @return packed section identity
     */
    ...
    /**
     * Decodes a stable packed identity.
     *
     * @param packed packed section identity
     * @return decoded section identity
     */
    ...
    /**
     * Decodes the signed x coordinate.
     *
     * @param packed packed section identity
     * @return signed x coordinate
     */
    ...
    /**
     * Decodes the signed y coordinate.
     *
     * @param packed packed section identity
     * @return signed y coordinate
     */
    ...
    /**
     * Decodes the signed z coordinate.
     *
     * @param packed packed section identity
     * @return signed z coordinate
     */
    ...
    /**
     * Returns the horizontal chunk containing this section.
     *
     * @return containing chunk identity
     */
    ...
    /**
     * Packs this identity into the stable 64-bit section layout.
     *
     * @return packed section identity
     */
    public long packed() {
