...
final class RtDynamicSceneLighting {
    ...
    private static float rgbRed(int rgb8) {
        return ((rgb8 >>> 16) & 0xff) / 255.0F;
    }

    private static float rgbGreen(int rgb8) {
        return ((rgb8 >>> 8) & 0xff) / 255.0F;
    }

    private static float rgbBlue(int rgb8) {
        return (rgb8 & 0xff) / 255.0F;
    }

    private static float rgbaRed(int rgba8) {
        return (rgba8 & 0xff) / 255.0F;
    }

    private static float rgbaGreen(int rgba8) {
        return ((rgba8 >>> 8) & 0xff) / 255.0F;
    }

    private static float rgbaBlue(int rgba8) {
        return ((rgba8 >>> 16) & 0xff) / 255.0F;
    }
